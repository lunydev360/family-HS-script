...
if IsMobile then
    ...
    -- Aimbot Button
    local AimbotButton = CreateMobileButton(
        "Aimbot\nOFF",
        UDim2.new(0, 10, 0.5, -90),
        Color3.fromRGB(255, 100, 100),
        function()
            Settings.Aimbot.Enabled = not Settings.Aimbot.Enabled
            AimbotButton.Text = Settings.Aimbot.Enabled and "Aimbot\nON" or "Aimbot\nOFF"
            AimbotButton.BackgroundColor3 = Settings.Aimbot.Enabled and Color3.fromRGB(100, 255, 100) or Color3.fromRGB(255, 100, 100)
        end
    )
